...
const Portfolio = () => {
  return (
    <section id='portfolio' className='relative py-24 overflow-hidden bg-gradient-to-b from-white via-red-50/20 to-white'>
      ...
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-red-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className='relative z-10 text-center px-6 lg:px-0 mb-16'>
        ...
        {/* Main heading */}
        <h2 className='text-5xl lg:text-6xl font-bold text-gray-900 mb-6' style={{ animation: 'fadeIn 0.8s ease-out 0.2s both' }}>
          Payout <span className='text-red-600'>Options</span>
        </h2>
        
        {/* Subheading */}
        <p className='text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed' style={{ animation: 'fadeIn 1s ease-out 0.4s both' }}>
